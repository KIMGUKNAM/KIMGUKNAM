...
public class Application2{
    ...
    public static void main(String[] args){
        ...
        System.out.println(123 % 0.7 ); //약간의 오차가 생깁니다
        ...
        * */
        ...
        /* 단, 결과는 실수 형태로 나오게 된다(아까 위에서 했던 전수와 실수의 연산 결과를 생각해보자*/
        ...
        /* 주의사항. 숫자로 된 문자열의 형태의 값은 '+' 연산의 결과가 되는 것을 주의하자*/
        System.out.println("============문자열과 형태의 숫자값 '+' 연산============");
        System.out.println("123" + "456");

        /* 4. 논리값 연산 */
        /* 4-1 논리값과 논리값 연산 */
        /* 논리값끼리 연산은 모든 연산자 사용이 불가능하다*/
...
*/ //에러발생
        ...
        System.out.println(true * 0.1);
        System.out.println(true / 0.1);
        System.out.println(true % 0.011);
*/ //에러발생

        /*4-4 논리값과 문자의 연산*/
        /* 논리값과 문자의 연산은 모든 연산자 사용이 불가능하다*/
        /* 이유는 문자는 내부적으로 숫자취급을 하기 때문에 결국 논리값과 숫자의 연산과 동일하다*/
