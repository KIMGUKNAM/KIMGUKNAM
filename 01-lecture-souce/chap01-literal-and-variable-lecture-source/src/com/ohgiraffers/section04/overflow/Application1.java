...
public class Application1 {
    public static void main(String[] args){
         ...
         * 발생한 carry를 버링 처리하고 sign bit를 반전시켜 최소값으로 순환시킴
         * */
        ...
        int nulti = firstNum * secondNum;     //7천억이 나와야함

        System.out.println("fistNum * secondNum = " + nulti);

        /* 3. 해결방법 */
        /* 오버플로우를 예측하고 더 큰 자료형으로 결과값을 받아서 처리한다. */
        long longMulti = firstNum * secondNum;

        System.out.println("fistNum * secondNum = " + longMulti); //안되지? 똑같지?
