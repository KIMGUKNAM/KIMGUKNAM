...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /*
        * 전달인자(argument)와 메개변수(parameter)를 이용한 메소드 호출
        ...
        * */
        ...
        /* 지역변수는 선언한 메소드 블럭 내부에서 사용이 가능하다. 이것을 지역변수의 스코프
        * 다른 메소드간 서로 공유해야하는 값이 존재하는 경우 메소드를 호출시 괄호 이용해서
        * 값을 전달할 수 있다.
        * 이때 전달하는 값을 전달인자(argument)부르고
        * 메소드 선언부 괄호안에 전달 인자를 받기 위해 선언하는 변수를 매개변서(parameter)
        * */
        ...
        /*1. 전달인자로 값 전달 테스트*/
        app3.testMethod(40);
        //app3.testMethod("40"); //매개변수는 int형이지만 인자 String이기 때문에 호출 할 수 없다.
        //app3.testMethod(20,30,40); //매개변수는 int이지만 인자는 3개이기 때문에 호출 할 수 없다.
