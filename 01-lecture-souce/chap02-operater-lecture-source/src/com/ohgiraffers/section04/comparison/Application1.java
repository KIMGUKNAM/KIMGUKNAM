...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("inum1과 inum2가 큰거나 같은지 비교" + (inum1 >= inum2));
        ...
        System.out.println("========정수 값 비교========");
        System.out.println("dum1과 dum2가 같은지 비교" + (dnum1==dnum2));
        System.out.println("dum1과 dum2가 다른지 비교" + (dnum1!=dnum2));
        System.out.println("dum1과 dum2가 큰지 비교" + (dnum1 > dnum2));
        System.out.println("dum1과 dum2가 큰거나 같은지 비교" + (dnum1 >= dnum2));
        System.out.println("dum1과 dum2가 작은지 비교" + (dnum1 < dnum2));
        System.out.println("dum1과 dum2가 작거나 같은지 비교" + (dnum1 <= dnum2));
        ...
        System.out.println("ch1과 ch2가 큰거나 같은지 비교" + (ch1 >= ch2));
