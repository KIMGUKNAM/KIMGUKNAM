...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 조건식 중 둘 중 하나라도 ture를 반환하면 true를 반환하기 때문에 앞에서 미리 true를
        * 뒤에 조건을 확인할 필요없이 true를 반환한다
        * 따라서 연산의 횟수를 줄이기 위해서는 || 연산의 경우 true가 나올 가능성이 높은 조건을 작성하는게 좋다.
        * */
